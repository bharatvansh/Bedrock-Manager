...
## Creator-First Policy & Official Redirects
...
The browser indexes Bedrock community projects across several categories:

- **Add-ons**: Custom gameplay mechanics, entities, items, and paired RP/BP systems.
- **Texture Packs**: Visual overhauls, UI enhancements, faithful textures, and dark modes.
- **Worlds & Maps**: Adventure maps, minigames, survival spawns, and parkour challenges.
- **Scripts**: Community utility scripts built on the Bedrock `@minecraft/server` API.
- **Skins**: Custom skin packs and creator collections.
...
## How to Install Discovered Packs
